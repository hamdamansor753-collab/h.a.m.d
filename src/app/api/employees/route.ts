/**
 * GET  /api/employees      — list employees for current tenant
 * POST /api/employees      — create a new employee
 *
 * runtime = 'nodejs' (Prisma). Zod-validated. Service-only Prisma.
 */
import { withTenantContext } from '@/core/auth/session'
import { listEmployees, createEmployee } from '@/modules/hr/payroll.service'
...
export async function GET() {
  try {
    const result = await withTenantContext(async () => listEmployees())
